...
TEST_BUILTINS_OBJS += test-object-array.o
TEST_BUILTINS_OBJS += test-object-list.o
...
check-builtins:: all man
	$(QUIET_CHECK)GIT_TEST_MAKE_CHECK_BUILTINS=true \
	GIT_TEST_REQUIRE_PREREQ=HAVE_BUILT_DOCS \
	$(MAKE) -C t T=t9551-make-check-builtins.sh
