# Templates, utilities and other "libraries" are included first.
include Makefile.d/template-track
...
$(eval $(call TRACK_template,GIT-USER-AGENT,GIT_USER_AGENT))
