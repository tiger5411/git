...
###############################################
# Most active -- Things I'm actively pursuing #
###############################################

## Various test_commit etc.
# => https://lore.kernel.org/git/cover-00.16-00000000000-20210412T110456Z-avarab@gmail.com/
avar/test-lib-various

## Needs avar/test-lib-various
# => https://lore.kernel.org/git/cover-0.5-00000000000-20210412T111601Z-avarab@gmail.com/
avar/describe-test-refactoring-2

## Related t/* and test-lib.sh fixes
# => https://lore.kernel.org/git/cover-0.2-00000000000-20210412T113247Z-avarab@gmail.com/
avar/svn-code-in-test-body

## userdiff.c fixes
# => http://lore.kernel.org/git/cover-00.10-0000000000-20210408T145833Z-avarab@gmail.com
avar/t4018-diff-hunk-header-regex-tests-4-beginning-2

## Properly support "--no-reschedule-failed-exec" under "rebase -i" in combination with config
# => https://lore.kernel.org/git/cover-0.3-0000000000-20210409T075713Z-avarab@gmail.com/
...
## doc make and lint fixes
# => https://lore.kernel.org/git/cover-0.7-0000000000-20210409T145728Z-avarab@gmail.com/
avar/doc-make-lint-fixes-2

## TODO: Needs re-roll!
## pickaxe prep for PCREv2
# => https://lore.kernel.org/git/20210216115801.4773-1-avarab@gmail.com/
avar/pcre2-fixes-diffcore-pickaxe-pcre-etc-3

## TODO: Needs a re-roll per https://lore.kernel.org/git/875z15kor5.fsf@evledraar.gmail.com/
...
## Post avar/t4018-diff-hunk-header-regex-tests-4-beginning-2 -- ejected as too large per:
...
## Post avar/pcre2-fixes-diffcore-pickaxe-pcre-etc-3
...
## Post avar/test-lib-various
avar/t0000-lib-subtest-split-and-refactor

## Post avar/test-lib-various and avar/t0000-lib-subtest-split-and-refactor
