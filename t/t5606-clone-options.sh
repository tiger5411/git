...
test_expect_success 'rejects invalid -o/--origin' '
	...
	grep "'\''bad...name'\'' is not a valid remote name" err
...
test_expect_success 'disallows --bare with --origin' '
	...
	test_debug "cat err" &&
	grep -e "options .--bare. and .--origin foo. cannot be used together" err
...
test_expect_success 'disallows --bare with --separate-git-dir' '
	...
	test_debug "cat err" &&
	grep -e "options .--bare. and .--separate-git-dir. cannot be used together" err
...
test_expect_success 'reject cloning shallow repository' '
	...
	grep -e "source repository is shallow, reject to clone." err &&
