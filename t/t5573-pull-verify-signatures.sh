...
test_expect_success GPG 'pull commit with untrusted signature with --verify-signatures and minTrustLevel=undefined' '
	...
	grep "has a good GPG signature" pulloutput
'
