...
test_expect_success 'fsck with invalid or bogus skipList input' '
	...
	grep "could not open.*: does-not-exist" err &&
	test_must_fail git -c fsck.skipList=.git/config -c fsck.missingEmail=ignore fsck 2>err &&
	grep "invalid object name: \[core\]" err
'
...
test_expect_success 'fsck with other accepted skipList input (comments & empty lines)' '
	...
	grep "missingEmail" err-with-comment &&
	...
	grep "missingEmail" err-with-empty-line
'
...
test_expect_success 'fsck with invalid abbreviated skipList input' '
	...
	grep "^fatal: invalid object name: " err-abbreviated
'
...
test_expect_success 'fsck.<unknownmsg-id> dies' '
	...
	grep "Unhandled message id: whatever" err
'
...
test_expect_success 'push with receive.fsck.missingEmail=warn' '
	...
	grep "skipping unknown msg id.*whatever" act &&
